...
export default function ManagerEditBookingPage() {
  ...
  return (
    <div className="page">
      <h1>Редагування бронювання #{booking.booking_id}</h1>
      <p className="subtitle">Клієнт: {booking.client?.full_name} ({booking.client?.email})</p>
      <form onSubmit={handleSubmit} className="form">
        ...
        <div className="form-actions">
          ...
          <button type="button" className="btn btn-outline" onClick={() => navigate('/manager/bookings')}>Скасувати</button>
        </div>
      </form>
    </div>
  );
